...
def main(args):
    ...
    for k, v in params_ait.items():
        InferEngine.clip_ait_exe.set_constant_with_tensor(k, v)
    ...
    for k, v in params_ait.items():
        InferEngine.unet_ait_exe.set_constant_with_tensor(k, v)
    ...
    for k, v in params_ait.items():
        InferEngine.vae_ait_exe.set_constant_with_tensor(k, v)
    ...
    for k, v in params_ait.items():
        InferEngine.controlnet_ait_exe.set_constant_with_tensor(k, v)
    ###########################################################
    ...
    image.save("{}/example_ait_controlnet_reduce_mem_{}.png".format(save_path, seed))
